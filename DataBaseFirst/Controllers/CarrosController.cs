...
namespace DataBaseFirst.Controllers
{
    public class CarrosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CarroId,Marca,Ano,Nome")] Carros carros)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CarroId,Marca,Ano,Nome")] Carros carros)
        {
